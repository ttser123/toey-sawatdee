      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        <div className="card-blueprint p-6 md:p-8 transition-colors hover:border-indigo-300">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h3 className="text-lg font-bold text-slate-800">Cloud Networking</h3>
          </div>
          <ul className="space-y-4 text-sm text-slate-600 list-disc list-outside ml-4 marker:text-slate-300">
          ...
          <div className="mt-5 pt-5 border-t border-slate-200">
            <p className="text-xs font-semibold text-slate-800 mb-1.5 uppercase tracking-wide font-mono">Architectural Trade-offs</p>
            <p className="text-sm text-slate-600 leading-relaxed"><strong className="font-medium text-slate-800">Why CloudFront Functions over Lambda@Edge?</strong> Chose CloudFront Functions for its sub-millisecond startup time and lower cost for simple URL rewrites, despite the limitation of not being able to access the network or filesystem.</p>
          </div>
        </div>
        ...
        <div className="card-blueprint p-6 md:p-8 transition-colors hover:border-indigo-300">
          <div className="flex items-center gap-3 mb-6">
            <span className="material-symbols-outlined text-indigo-600 bg-indigo-50 p-2.5 rounded-sm">shield_lock</span>
        ...
        <div className="card-blueprint p-6 md:p-8 transition-colors hover:border-indigo-300">
          <div className="flex items-center gap-3 mb-6">
            <span className="material-symbols-outlined text-emerald-600 bg-emerald-50 p-2.5 rounded-sm">api</span>
            <h3 className="text-lg font-bold text-slate-800">Serverless Backend APIs</h3>
          </div>
          <ul className="space-y-4 text-sm text-slate-600 list-disc list-outside ml-4 marker:text-slate-300">
            ...
            <li className="pl-1"><span className="leading-relaxed">Optimized client-side rendering performance by executing parallel asynchronous data fetches (<code className="bg-slate-100 px-1.5 py-0.5 rounded-sm text-slate-800 text-[12px] font-mono border border-slate-200">Promise.all</code>).</span></li>
          </ul>
          <div className="mt-5 pt-5 border-t border-slate-200">
            <p className="text-xs font-semibold text-slate-800 mb-1.5 uppercase tracking-wide font-mono">Architectural Trade-offs</p>
            <p className="text-sm text-slate-600 leading-relaxed mb-3"><strong className="font-medium text-slate-800">Why API Gateway & Lambda over an Express.js EC2 instance?</strong> Chose serverless to completely eliminate OS patching (DevSecOps mindset) and minimize idle costs, despite the initial pain of debugging CORS preflight limits.</p>
            <p className="text-sm text-slate-600 leading-relaxed"><strong className="font-medium text-slate-800">Why DynamoDB instead of RDS/PostgreSQL?</strong> Needed a fast, scalable key-value store for simple telemetry payloads. DynamoDB On-Demand keeps the cost near zero during idle hours, though it required writing custom DecimalEncoder serialization in Python to prevent JSON parsing crashes.</p>
          </div>
        </div>
        ...
        <div className="card-blueprint p-6 md:p-8 transition-colors hover:border-indigo-300">
          <div className="flex items-center gap-3 mb-6">
            <span className="material-symbols-outlined text-indigo-600 bg-indigo-50 p-2.5 rounded-sm">rocket_launch</span>
            <h3 className="text-lg font-bold text-slate-800">CI/CD & Workflows</h3>
          </div>
          <ul className="space-y-4 text-sm text-slate-600 list-disc list-outside ml-4 marker:text-slate-300">
          ...
          <div className="mt-5 pt-5 border-t border-slate-200">
            <p className="text-xs font-semibold text-slate-800 mb-1.5 uppercase tracking-wide font-mono">Architectural Trade-offs</p>
            <p className="text-sm text-slate-600 leading-relaxed"><strong className="font-medium text-slate-800">Why GitHub Actions over AWS CodePipeline?</strong> Kept the CI/CD configuration closer to the code repository for faster iteration, though it required strict management of AWS IAM credentials via GitHub Secrets to prevent exposure.</p>
          </div>
        </div>

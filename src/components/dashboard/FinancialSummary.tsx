...
export const FinancialSummary = () => {
  ...
  return (
    <section className={`grid grid-cols-1 md:grid-cols-2 gap-4 transition-all duration-500`}>
      {/* AVAILABLE ASSETS */}
      <div className="card-blueprint p-6 flex flex-col justify-center border-l-4 border-l-indigo-600">
      ...
      <div className={`card-blueprint p-6 flex flex-col justify-center border-l-4 transition-colors duration-300 ${
        ...
        <div className="flex items-baseline gap-2">
          <span className={`text-3xl font-black font-mono tracking-tighter ${isCritical ? 'text-rose-700' : 'text-slate-800'}`}>
